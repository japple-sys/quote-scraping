import requests
from bs4 import writer
from time import sleep
from random import choice

#list to store of the url is constant
...
while guess.lower() != quote["author"].lower() and remaining_guesses > 0:
    guess = input(
        f"Who said this quote? Guesses remaining{remaing_guesses}")
    ...
    if remaining_guesses == 3:
        res = requests.get(f"{base_url}{quote['bio-like']}")
        soup = BeautifulSoup(res.text, "html.parser")
